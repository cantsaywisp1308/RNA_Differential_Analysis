...
INPUT_DIR="/home/cantsaywisp1308/output/Illumina_25/"
OUTPUT_DIR="/home/cantsaywisp1308/output/output/BAM_files/illumina_25/"
...
for i in {1..9}; do
	      ...
	      INPUT_SAM="${INPUT_DIR}3164_${i}_S${i}_.sam"
		            
		# Check if the input SAM file exists
		if [[ -f "$INPUT_SAM" ]]; then
		# Construct the output BAM filenames
		OUTPUT_BAM="${OUTPUT_DIR}3164_${i}_S${i}.bam"
		SORTED_BAM="${OUTPUT_DIR}3164_${i}_S${i}_sorted.bam"
